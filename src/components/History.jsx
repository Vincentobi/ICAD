...
<h2 className="text-text-light dark:text-text-dark text-3xl font-bold leading-tight tracking-[-0.015em] text-center">A Journey of<span className='text-secondary'> Impact</span></h2>
<div className="mt-12 max-w-2xl mx-auto">
<div className="relative flex flex-col gap-8">
<div className="timeline-item relative pl-10 pb-4 ">
<div className="timeline-dot"></div>
<Journey bgImage={assets.project10} title="2003 - The Beginning" subtitle="Livelihood project in skill acquisition and capacity building." />
</div>
<div className="timeline-item relative pl-10 pb-4">
<div className="timeline-dot"></div>
...
<div className="timeline-item relative pl-10 pb-4">
<div className="timeline-dot"></div>
<Journey bgImage={assets.project11} title="2014 - Quality Health Programs" subtitle="Continuation of providing quality health care and training programs at grassroots - The hepatitis prevention and control in Gembu, Taraba state." />
</div>
<div className="timeline-item relative pl-10 pb-4">
<div className="timeline-dot"></div>
<Journey bgImage={assets.project12} title="2015 - ACTION2015.org & CIVICUS" subtitle="ICAD mobilized the youth and in-school community to raise awareness and the funding future development(FfD) at the backdrop the UN big moment - signing of the Sustainable Development Goal (SDG) by world leaders at the UN headquaterin NewYork" />
</div>
<div className="timeline-item relative pl-10 pb-4">
<div className="timeline-dot"></div>
...
<Journey bgImage={assets.project3} title="2021 - Plant for the Planet" subtitle="We organized the first ever plant for the planet program (P4P) in Jos, with over 10 schools participating." />
</div>
</div>
</div>
</div>
