...
<button className="rounded-lg bg-white px-5 py-3 text-base font-semibold text-primary shadow-sm hover:bg-gray-100 transition-colors">Donate Now</button>
<a className="text-base font-semibold leading-6 text-white" href="#">Learn more <span aria-hidden="true">→</span></a>
</div>
